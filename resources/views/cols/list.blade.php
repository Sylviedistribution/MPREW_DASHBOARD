...
@section('contents')
    <div class="container-fluid py-4">
        <div class="row d-flex align-items-center">
            <form method="GET" action="{{ route('cols.filter') }}" class="form-inline d-flex w-100 flex-wrap">
                @csrf
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        <h6>Liste des cols</h6>
                        <a href="{{ route('cols.create') }}" class="btn btn-success">
                            <i class="fas fa-plus"></i> Ajouter un col
                        </a>
                    </div>
