...
@section('contents')
    <div class="offset-3 col-md-6">
        <div class="card" style="background-color: #b3d4fc">
            <h3 class="text-center">AJOUTER UNE COUPE</h3>
            <div class="card-body offset-2">
                <form method="POST" action="{{ route('coupes.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-8">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                      name="description" placeholder="Décrivez votre coupe..."></textarea>
                            @error('description')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
