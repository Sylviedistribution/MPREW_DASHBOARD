    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if(auth('admin')->check())
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('artisans*') ? 'active' : '' }}"
                       href="{{ route('artisans.list') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-circle-08 text-dark text-sm opacity-10"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('manches*') ? 'active' : '' }}"
                       href="{{ route('manches.list') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-palette text-dark text-sm opacity-10"></i>
                        </div>
            ...
            @if(auth('artisan')->check())
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('transactions*') ? 'active' : '' }}"
                       href="{{ route('transactions.artisan') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
