...
@section('contents')
    <div class="offset-3 col-md-6">
        <div class="card" style="background-color: #b3d4fc">
            <h3 class="text-center">AJOUTER DES MANCHES</h3>
            <div class="card-body offset-2">
                <form method="POST" action="{{ route('manches.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Nom -->
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('nom') is-invalid @enderror" name="nom" type="text"
                                   id="nom" onfocus="focused(this)" onfocusout="defocused(this)">
                            @error('nom')
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                      name="description" placeholder="Décrivez vos manches..."></textarea>
                            @error('description')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
